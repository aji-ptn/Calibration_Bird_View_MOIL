    ...
    def __setCamera_parameter(self, parameter, cameraType):
        ...
        with open(parameter) as f:
            ...
            if cameraType in data.keys():
                self.__camera_name = data[cameraType][0]
                self.__camera_fov = data[cameraType][1]
                self.__sensor_width = data[cameraType][2]
                self.__sensor_height = data[cameraType][3]
                self.__Icx = data[cameraType][4]
                self.__Icy = data[cameraType][5]
                self.__ratio = data[cameraType][6]
                self.__image_width = data[cameraType][7]
                self.__image_height = data[cameraType][8]
                self.__calibration_ratio = data[cameraType][9]
                self.__parameter_0 = data[cameraType][10]
                print(self.__parameter_0)
                self.__parameter_1 = data[cameraType][11]
                self.__parameter_2 = data[cameraType][12]
                self.__parameter_3 = data[cameraType][13]
                self.__parameter_4 = data[cameraType][14]
                self.__parameter_5 = data[cameraType][15]
