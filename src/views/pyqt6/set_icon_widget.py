...
class SetIconUserInterface(object):
    ...
    def set_icon_change_mode_view_video(self, status="birds_view"):
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("views/ui_design/icon/default.png"),
                       QtGui.QIcon.Mode.Normal,
                       QtGui.QIcon.State.Off)
        if status == "original":
            icon.addPixmap(QtGui.QPixmap("views/ui_design/icon/undo.png"),
                           QtGui.QIcon.Mode.Normal,
                           QtGui.QIcon.State.Off)

        self.__main_ui.button_change_view.setIcon(icon)
        self.__main_ui.button_change_view.setIconSize(QtCore.QSize(30, 30))
    ...
    def icon_zoom_in_zoom_out(self):
        ...
        self.icon.addPixmap(QtGui.QPixmap("views/ui_design/icon/zoom_in.png"),
                            QtGui.QIcon.Mode.Normal,
                            QtGui.QIcon.State.Off)
        self.__main_ui.button_zoom_in.setIcon(self.icon)
        self.__main_ui.button_zoom_in.setIconSize(QtCore.QSize(30, 30))

        self.icon.addPixmap(QtGui.QPixmap("views/ui_design/icon/zoom_out.png"),
                            QtGui.QIcon.Mode.Normal,
                            QtGui.QIcon.State.Off)
        self.__main_ui.button_zoom_out.setIcon(self.icon)
        self.__main_ui.button_zoom_out.setIconSize(QtCore.QSize(30, 30))
