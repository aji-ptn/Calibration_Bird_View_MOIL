...
class MainController:
    def __init__(self, model):
        """
        The __init__ method lets the class initialize the object's attributes main controllers

        Args:
            model: given information control from user to load data in model
        """
        super().__init__()
    ...
    def process_generating_anypoint_image(self, i):
        ...
        reverseImage = self.model.list_original_image[i]
        ...
        self.model.list_anypoint_image[i] = remap_image(reverseImage, map_x_anypoint, map_y_anypoint)
