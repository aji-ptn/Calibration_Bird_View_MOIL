...
def merge_image_4_camera_center_clicked(image_crop, properties_image, gradient_mode):
    keys = list(properties_image)

    list_pos_image_1_front_left = properties_image[keys[0]]["front_left"]
    list_pos_image_1_front_right = properties_image[keys[0]]["front_right"]

    list_pos_image_2_left_front = properties_image[keys[1]]["left_front"]
    list_pos_image_2_left_rear = properties_image[keys[1]]["left_rear"]

    list_pos_image_3_right_front = properties_image[keys[2]]["right_front"]
    list_pos_image_3_right_rear = properties_image[keys[2]]["right_rear"]

    list_pos_image_4_rear_left = properties_image[keys[3]]["rear_left"]
    list_pos_image_4_rear_right = properties_image[keys[3]]["rear_right"]

    pos_image_1_front_left = list_pos_image_1_front_left[0]
    # pos_image_1_front_left[0] = 500
    # pos_image_1_front_left[1] = 100
    pos_image_1_front_right = list_pos_image_1_front_right[0]
    # pos_image_1_front_right[1] = 400
    # pos_image_1_front_right[0] = image_crop[0].shape[1] - image_crop[2] .shape[1]

    pos_image_2_left_front = list_pos_image_2_left_front[0]
    # pos_image_2_left_front[0] = 250
    pos_image_2_left_rear = list_pos_image_2_left_rear[0]
    # pos_image_2_left_rear[0] = 300
    # pos_image_2_left_rear[1] = image_crop[1].shape[0] - image_crop[3].shape[0] - 100

    pos_image_3_right_front = list_pos_image_3_right_front[0]
    # pos_image_3_right_front[0] = 200
    # pos_image_3_right_front[1] = 200
    pos_image_3_right_rear = list_pos_image_3_right_rear[0]

    pos_image_4_rear_left = list_pos_image_4_rear_left[0]
    # pos_image_4_rear_left[0] = 500
    pos_image_4_rear_right = list_pos_image_4_rear_right[0]
    ...
    draw_image_4_point(image_1, list_pos_image_1_front_right)
    draw_image_4_point(image_1, list_pos_image_1_front_left)
    draw_image_4_point(image_2, list_pos_image_2_left_front)
    draw_image_4_point(image_2, list_pos_image_2_left_rear)
    draw_image_4_point(image_3, list_pos_image_3_right_front)
    draw_image_4_point(image_3, list_pos_image_3_right_rear)
    draw_image_4_point(image_4, list_pos_image_4_rear_left)
    draw_image_4_point(image_4, list_pos_image_4_rear_right)
    ...
    # image_3 process
    shift_3_x = pos_image_1_front_right[0] - pos_image_3_right_front[0]
