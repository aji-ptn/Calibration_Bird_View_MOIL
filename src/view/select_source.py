...
# Form implementation generated from reading ui file 'ui_design/select_source.ui'
#
...
class Ui_OpenVideo_OpenCam(object):
    ...
    def retranslateUi(self, OpenVideo_OpenCam):
        ...
        self.label.setText(_translate("OpenVideo_OpenCam", "Source 1"))
        self.label_2.setText(_translate("OpenVideo_OpenCam", "Source 2"))
        self.label_3.setText(_translate("OpenVideo_OpenCam", "Source 3"))
        self.label_4.setText(_translate("OpenVideo_OpenCam", "Source 4"))
        self.label_5.setText(_translate("OpenVideo_OpenCam", "Source 5"))
        self.label_6.setText(_translate("OpenVideo_OpenCam", "Source 6"))
