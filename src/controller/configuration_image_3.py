...
class ConfigurationImage3:
    ...
    def change_properties_optical_center(self):
        ...
        """
        self.view_controller.model.model_data.properties_image["Image_3"]["alpha"] = self.view_controller.main_ui.val_alpha_image_3.value()
        self.view_controller.model.model_data.properties_image["Image_3"]["beta"] = self.view_controller.main_ui.val_beta_image_3.value()
        self.view_controller.model.process_generating_anypoint_image(2)
    ...
    def change_properties_anypoint(self):
        ...
        """
        self.view_controller.model.model_data.properties_image["Image_3"]["zoom"] = self.view_controller.main_ui.val_zoom_image_3.value()
        self.view_controller.model.model_data.properties_image["Image_3"]["rotate"] = self.view_controller.main_ui.val_rotate_image_3.value()
        self.view_controller.model.process_generating_anypoint_image(2)
        self.view_controller.show_to_window.show_overlay_and_birds_view()
        if self.view_controller.model.model_data.list_frame_video:
            self.view_controller.model.update_properties_anypoint()
    ...
    def change_properties_overlay(self):
        ...
        each acton of the part image 3 in the user interface frame
        """
        self.view_controller.model.model_data.properties_image["Image_3"]["shift_x"] = self.view_controller.main_ui.val_coordinate_x_image_3.value()
        self.view_controller.model.model_data.properties_image["Image_3"]["shift_y"] = self.view_controller.main_ui.val_coordinate_y_image_3.value()
        self.view_controller.show_to_window.show_overlay_and_birds_view()
    ...
    def change_properties_cropping(self):
        ...
        """
        self.view_controller.model.model_data.properties_image["Image_3"]["crop_top"] = self.view_controller.main_ui.val_crop_top_image_3.value()
        self.view_controller.model.model_data.properties_image["Image_3"]["crop_bottom"] = self.view_controller.main_ui.val_crop_bottom_image_3.value()
        self.view_controller.model.model_data.properties_image["Image_3"]["crop_left"] = self.view_controller.main_ui.val_crop_left_image_3.value()
        self.view_controller.model.model_data.properties_image["Image_3"]["crop_right"] = self.view_controller.main_ui.val_crop_right_image_3.value()
        self.view_controller.show_to_window.show_overlay_and_birds_view()
    ...
    def update_properties(self):
        ...
        """
        self.view_controller.model.model_data.properties_image["Image_3"] = {}
        self.view_controller.model.model_data.properties_image["Image_3"]["alpha"] = self.view_controller.main_ui.val_alpha_image_3.value()
        self.view_controller.model.model_data.properties_image["Image_3"]["beta"] = self.view_controller.main_ui.val_beta_image_3.value()
        self.view_controller.model.model_data.properties_image["Image_3"]["zoom"] = self.view_controller.main_ui.val_zoom_image_3.value()
        self.view_controller.model.model_data.properties_image["Image_3"]["rotate"] = self.view_controller.main_ui.val_rotate_image_3.value()
    ...
    def load_config(self):
        ...
        """
        self.block_signal()
        self.view_controller.main_ui.val_alpha_image_3.setValue(self.view_controller.model.model_data.properties_image["Image_3"]["alpha"])
        self.view_controller.main_ui.val_beta_image_3.setValue(self.view_controller.model.model_data.properties_image["Image_3"]["beta"])
        self.view_controller.main_ui.val_zoom_image_3.setValue(self.view_controller.model.model_data.properties_image["Image_3"]["zoom"])
        self.view_controller.main_ui.val_rotate_image_3.setValue(self.view_controller.model.model_data.properties_image["Image_3"]["rotate"])
        self.view_controller.main_ui.val_coordinate_x_image_3.setValue(self.view_controller.model.model_data.properties_image["Image_3"]["shift_x"])
        self.view_controller.main_ui.val_coordinate_y_image_3.setValue(self.view_controller.model.model_data.properties_image["Image_3"]["shift_y"])
        self.view_controller.main_ui.val_crop_top_image_3.setValue(self.view_controller.model.model_data.properties_image["Image_3"]["crop_top"])
        self.view_controller.main_ui.val_crop_bottom_image_3.setValue(self.view_controller.model.model_data.properties_image["Image_3"]["crop_bottom"])
        self.view_controller.main_ui.val_crop_left_image_3.setValue(self.view_controller.model.model_data.properties_image["Image_3"]["crop_left"])
        self.view_controller.main_ui.val_crop_right_image_3.setValue(self.view_controller.model.model_data.properties_image["Image_3"]["crop_right"])
        self.unblock_signal()
