...
class ConfigurationImage1:
    ...
    def change_properties_optical_center(self):
        ...
        """
        self.view_controller.model.model_data.properties_image["Image_1"][
            "alpha"] = self.view_controller.main_ui.val_alpha_image_1.value()
        self.view_controller.model.model_data.properties_image["Image_1"][
            "beta"] = self.view_controller.main_ui.val_beta_image_1.value()
        self.view_controller.model.process_generating_anypoint_image(0)
    ...
    def load_config(self):
        ...
        self.view_controller.main_ui.val_alpha_image_1.setValue(
            self.view_controller.model.model_data.properties_image["Image_1"]["alpha"])
        self.view_controller.main_ui.val_beta_image_1.setValue(
            self.view_controller.model.model_data.properties_image["Image_1"]["beta"])
        self.view_controller.main_ui.val_zoom_image_1.setValue(
            self.view_controller.model.model_data.properties_image["Image_1"]["zoom"])
        self.view_controller.main_ui.val_rotate_image_1.setValue(
            self.view_controller.model.model_data.properties_image["Image_1"]["rotate"])
        self.view_controller.main_ui.val_coordinate_x_image_1.setValue(
            self.view_controller.model.model_data.properties_image["Image_1"]["shift_x"])
        self.view_controller.main_ui.val_coordinate_y_image_1.setValue(
            self.view_controller.model.model_data.properties_image["Image_1"]["shift_y"])
        self.view_controller.main_ui.val_crop_top_image_1.setValue(
            self.view_controller.model.model_data.properties_image["Image_1"]["crop_top"])
        self.view_controller.main_ui.val_crop_bottom_image_1.setValue(
            self.view_controller.model.model_data.properties_image["Image_1"]["crop_bottom"])
        self.view_controller.main_ui.val_crop_left_image_1.setValue(
            self.view_controller.model.model_data.properties_image["Image_1"]["crop_left"])
        self.view_controller.main_ui.val_crop_right_image_1.setValue(
            self.view_controller.model.model_data.properties_image["Image_1"]["crop_right"])
        self.unblock_signal()
