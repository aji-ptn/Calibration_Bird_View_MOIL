...
class CalibProperties:
    def __init__(self, view_controller):
        ...
        self.view_controller.main_ui.button_save_config.clicked.connect(self.view_controller.model.save_config_to_file)
        # self.view_controller.main_ui.button_save_config.clicked.connect(self.view_controller.model.save_image_calibration)
    ...
    def onclick_load_config(self):
        ...
        config_path = select_file(self.view_controller, "Select config !!", "../data_config",
                                  "config file (*.yaml)")
        if config_path:
            self.view_controller.model.load_config(config_path)
    ...
    def initialize_properties(self):
        ...
        self.view_controller.model.initialize_image_data()
        self.view_controller.model.moildev = []
